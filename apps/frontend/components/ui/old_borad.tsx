...
//   ];
// const addeffect = useCallback((opt: any, canvas: fabric.Canvas | null,selectedTool: string) => {
//   const cn = canvas || opt.target?.canvas;
//   if (!cn || !opt.e) return;

//   const pointer = cn.getPointer(opt.e);
//   console.log("selected tool in addeffect111",selectedTool);
...
//   }
//     if(!canvas) return;
//     console.log("removing event",canvas);
//     canvas.off('mouse:down', (opt) => {addeffect(opt,canvas,selectedTool)});
...
// useEffect(() => {
//   console.log("callback added",selectedTool)
//   console.log("fabric canvas",canvas);
//   if(!canvas) return;
//   canvas.off('mouse:down', (opt) => {addeffect(opt,canvas,selectedTool)});
//   console.log("removing event",canvas);
//   canvas.on('mouse:down', (opt) => {addeffect(opt,canvas,selectedTool)});
//   console.log("adding event",canvas);
// }, [canvas,selectedTool]);
...
//         fabricCanvas.on('mouse:down', (opt) => {addeffect(opt,fabricCanvas,selectedTool )});
//         fabricCanvas.on("object:added", broadcast);
//         fabricCanvas.on("object:modified", broadcast);
//         fabricCanvas.on("object:removed", broadcast);
